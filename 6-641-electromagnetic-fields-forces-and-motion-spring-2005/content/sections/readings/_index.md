...
menu:
  leftnav:
    identifier: 2731d27306a674aa8502ee2adfb6aaaf
    name: Readings
    weight: 30
title: Readings
type: course
uid: 2731d27306a674aa8502ee2adfb6aaaf

---

The readings in the table below are separated into textbook sections and video demonstrations. The textbook sections come from the Zahn and Woodson/Melcher textbooks. The video demonstrations accompany the Haus/Melcher textbook. The Haus/Melcher textbook is used for the first half of the course in addition to the textbook sections listed below. All three textbooks can be found [here]({{< baseurl >}}/sections/textbooks).
...
| --- | --- | --- | --- |
| {{< td-colspan 4 >}}**I. Maxwell's equations and boundary conditions**{{< /td-colspan >}} ||||
| L1 | Integral form of Maxwell's equations | &nbsp; | Z - 2.1-2.4, 5.1-5.2 |
| R1 | Gauss' and Ampere's law problems using integral laws |  {{< br >}}{{< br >}} H/M - 1.4.1 - Magnetic field of a line current {{< br >}}{{< br >}} H/M - 1.6.1 - Voltmeter reading induced by magnetic induction {{< br >}}{{< br >}}  | Z - 2.4 |
...
| {{< td-colspan 4 >}}**II. Polarization, conduction, and magnetization**{{< /td-colspan >}} ||||
| R7 | Dielectric polarization and capacitance | H/M - 6.6.1 - Artificial dielectric | Z - 3.1 |
| L7 | Polarization and conduction |  {{< br >}}{{< br >}} H/M - 7.7.1 - Relaxation of charge on particle in Ohmic conductor {{< br >}}{{< br >}} H/M - Supplement: Van de Graaff and Kelvin generators {{< br >}}{{< br >}}  | Z - 3.2 |
